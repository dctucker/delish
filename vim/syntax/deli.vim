...
syn region deliFunction   start=+\w*(+ end=+)+ fold contains=deliString,deliDollarVar,deliMacro,deliReserved
...
hi def link deliFile             StorageClass
