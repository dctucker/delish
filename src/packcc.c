...
static void pcc_action_IfElseBlock_0(deli_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
...
static void pcc_action_IfElseBlock_1(deli_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
...
static void pcc_action_IfElseBlock_2(deli_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e1 (*__pcc_in->data.leaf.values.buf[0])
#define c1 (*__pcc_in->data.leaf.values.buf[1])
...
static void pcc_action_IfElseBlock_3(deli_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e1 (*__pcc_in->data.leaf.values.buf[0])
#define c1 (*__pcc_in->data.leaf.values.buf[1])
#define e2 (*__pcc_in->data.leaf.values.buf[2])
#define c2 (*__pcc_in->data.leaf.values.buf[3])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
#define _0e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.end))
    NA( __, e2 ); NA( __, c2 );
...
static void pcc_action_IfElseBlock_4(deli_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e1 (*__pcc_in->data.leaf.values.buf[0])
#define c1 (*__pcc_in->data.leaf.values.buf[1])
...
#define c3 (*__pcc_in->data.leaf.values.buf[5])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
#define _0e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.end))
    NA( __, e3 ); NA( __, c3 );
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_IfElseBlock(deli_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_Conditional(deli_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 1);
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_IfElseBlock, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    {
        pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_Conditional_0, 1, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->cur;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_IfElseBlock(deli_context_t *ctx) {
    pcc_thunk_chunk_t *const chunk = pcc_thunk_chunk__create(ctx->auxil);
    chunk->pos = ctx->cur;
    PCC_DEBUG(ctx->auxil, PCC_DBG_EVALUATE, IfElseBlock, ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->buffer.len - chunk->pos));
    ctx->level++;
    ...
    L0002:;
        {
            pcc_value_t null;
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_IfElseBlock_0, 6, 0);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->cur;
    ...
    {
        pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_IfElseBlock_1, 6, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
    ...
    }
    {
        ...
        for (i = 0;; i++) {
            ...
            {
                if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Condition, &chunk->thunks, &(chunk->values.buf[2]))) goto L0008;
                goto L0009;
            L0008:;
                {
                    pcc_value_t null;
                    pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_IfElseBlock_2, 6, 0);
                    thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
                    thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
                    thunk->data.leaf.capt0.range.start = chunk->pos;
                    thunk->data.leaf.capt0.range.end = ctx->cur;
            ...
            {
                pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_IfElseBlock_3, 6, 0);
                thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
                thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
    ...
    }
    {
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Else, &chunk->thunks, &(chunk->values.buf[4]))) goto L0011;
        {
            const size_t p0 = ctx->cur;
            const size_t n0 = chunk->thunks.len;
            int i;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Body, &chunk->thunks, &(chunk->values.buf[5]))) goto L0011;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_IfElseBlock_4, 6, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.values.buf[2] = &(chunk->values.buf[2]);
            thunk->data.leaf.values.buf[3] = &(chunk->values.buf[3]);
    ...
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_MATCH, IfElseBlock, ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    return chunk;
L0000:;
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_NOMATCH, IfElseBlock, ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    pcc_thunk_chunk__destroy(ctx->auxil, chunk);
    return NULL;
}
...
/*
IfBlock       <- "if"      S+ e:Condition                           ~{ ER("expected condition after `if`"); }
                           S+ c:Body _                               { DK( Conditional, e, c ); }

IfElifBlock   <- "if"      S+ e1:Condition                           ~{ ER("expected condition after `if`"); }
                           S+ c1:Body                                 { DK( Conditional, e1, c1 ); }
              (  "elif"    S+ e2:Condition                           ~{ ER("expected condition after `if`"); }
                           S+ c2:Body                                 { NA( $$, e2 ); NA( $$, c2 ); }
              )* S+ "else" S+ c3:Body _                               { NA( $$, c3 ); }
*/
